defmodule Pongdom.Accounts.Users do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Pongdom.Repo)
  ...
  """
  def valid_password?(%Pongdom.Accounts.Users{hashed_password: hashed_password}, password)
