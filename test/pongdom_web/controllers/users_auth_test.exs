defmodule PongdomWeb.UsersAuthTest do
  use PongdomWeb.ConnCase, async: true

  alias Pongdom.Accounts
  alias PongdomWeb.UsersAuth
  import Pongdom.AccountsFixtures

  @remember_me_cookie "_pongdom_web_users_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PongdomWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_users/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PongdomWeb.Endpoint.subscribe(live_socket_id)
